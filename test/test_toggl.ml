...
let normal_behaviour_suite =
  TestNormalBehaviour.
    [ test_case
        "Creating time entry response is parsed"
        `Quick
        test_create_time_entry
    ; test_case
        "Starting time entry response is parsed"
        `Quick
        test_start_time_entry
    ; test_case
        "Stopping time entry response is parsed"
        `Quick
        test_stop_time_entry
    ; test_case
        "Getting current time entry response is parsed"
        `Quick
        test_current_time_entry
    ; test_case
        "Getting specified time entry response is parsed"
        `Quick
        test_time_entry_details
    ; test_case
        "Deleting specified time entry response is parsed"
        `Quick
        test_delete_time_entry
    ; test_case
        "Getting all time entries without query response is parsed"
        `Quick
        test_list_time_entries_no_query
    ; test_case
        "Getting all time entries with query response is parsed"
        `Quick
        test_list_time_entries_query
    ; test_case
        "Getting no time entries with query is parsed"
        `Quick
        test_list_time_entries_future
    ; test_case
        "Getting all workspaces response is parsed"
        `Quick
        test_list_workspaces
    ; test_case
        "Getting all projects response is parsed"
        `Quick
        test_list_projects
    ]
...
let error_suite =
  TestConnectionError.
    [ test_case
        "Creating time entry response returns error"
        `Quick
        test_create_time_entry
    ; test_case
        "Starting time entry response returns error"
        `Quick
        test_start_time_entry
    ; test_case
        "Stopping time entry response returns error"
        `Quick
        test_stop_time_entry
    ; test_case
        "Getting current time entry response returns error"
        `Quick
        test_current_time_entry
    ; test_case
        "Getting specified time entry response returns error"
        `Quick
        test_time_entry_details
    ; test_case
        "Deleting specified time entry response returns error"
        `Quick
        test_delete_time_entry
    ; test_case
        "Getting all workspaces response returns error"
        `Quick
        test_list_workspaces
    ; test_case
        "Getting all projects response returns error"
        `Quick
        test_list_projects
    ]
